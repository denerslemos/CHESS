...
Event::Event(const VarMap& var_map)
    : norm_(var_map["normalization"].as<double>()),
	  npartmax_(var_map["npart-max"].as<int>()),// Dener
      npartmin_(var_map["npart-min"].as<int>()),// Dener
	  multmax_(var_map["mult-max"].as<double>()),// Dener
      multmin_(var_map["mult-min"].as<double>()),// Dener
