...
int main(int argc, char* argv[]) {
  ...
  phys_opts.add_options()
    ...
    ("npart-min",
     po::value<int>()->value_name("INT")->default_value(0, "0"),// Dener
     "minimum npart")
    ("npart-max",
     po::value<int>()->value_name("INT")->default_value(-1, "auto"),// Dener
     "maximum npart")
    ("mult-min",
     po::value<double>()->value_name("FLOAT")->default_value(0, "0"),// Dener
     "minimum mult")
    ("mult-max",
     po::value<double>()->value_name("FLOAT")->default_value(-1, "auto"),// Dener
     "maximum mult")
    ("random-seed",
