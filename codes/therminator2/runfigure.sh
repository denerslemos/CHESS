...
root -b -l -q -x "./macro/figure_distptLHC.C(\"$TH2_EVENTS_DIR_\", $TH2_EVENTS_COUNT_)"
root -b -l -q -x "./macro/figure_v1chptd2.C(\"$TH2_EVENTS_DIR_\", $TH2_EVENTS_COUNT_)"
root -b -l -q -x "./macro/figure_v2chptd2.C(\"$TH2_EVENTS_DIR_\", $TH2_EVENTS_COUNT_)"
root -b -l -q -x "./macro/figure_v3chptd2.C(\"$TH2_EVENTS_DIR_\", $TH2_EVENTS_COUNT_)"
root -b -l -q -x "./macro/figure_v4chptd2.C(\"$TH2_EVENTS_DIR_\", $TH2_EVENTS_COUNT_)"
root -b -l -q -x "./macro/figure_v5chptd2.C(\"$TH2_EVENTS_DIR_\", $TH2_EVENTS_COUNT_)"
root -b -l -q -x "./macro/figure_v6chptd2.C(\"$TH2_EVENTS_DIR_\", $TH2_EVENTS_COUNT_)"
#root -b -l -q -x "./macro/figure_v7chptd2.C(\"$TH2_EVENTS_DIR_\", $TH2_EVENTS_COUNT_)"
#root -b -l -q -x "./macro/figure_v2pt.C(\"$TH2_EVENTS_DIR_\", $TH2_EVENTS_COUNT_)"
#root -b -l -q -x "./macro/figure_v4pt.C(\"$TH2_EVENTS_DIR_\", $TH2_EVENTS_COUNT_)"
#root -b -l -q -x "./macro/figure_v1pt.C(\"$TH2_EVENTS_DIR_\", $TH2_EVENTS_COUNT_)"
#root -b -l -q -x "./macro/figure_distpt_hadron.C(\"$TH2_EVENTS_DIR_\", $TH2_EVENTS_COUNT_)"
...
#root -b -l -q -x "./macro/figure_v2pserap.C(\"$TH2_EVENTS_DIR_\", $TH2_EVENTS_COUNT_)"
