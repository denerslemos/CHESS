...
#define  _FIGURE_NAME_ "fig_v2chpt"
#define  _N_HISTOGRAMS_ 3

void figure_v2chptd(TString aEventDir = "./events/", Int_t aEventFiles = 1)
{
// ##########################################################################
// # READ ROOT FILES
// ##########################################################################
...
// Create histograms
  H1D[0] = new TH1D("H0", "h^{#pm}", XBins, XMin, XMax);
  H1D[0]->GetXaxis()->SetTitle("p_{T} [GeV/c]");
  H1D[0]->GetYaxis()->SetTitle("v_{2}");
  H1D[0]->Sumw2();
  H1D[1] = (TH1D*) H1D[0]->Clone("H1");  H1D[1]->SetTitle("#pi^{#pm}");
  H1D[2] = (TH1D*) H1D[0]->Clone("H2");  H1D[2]->SetTitle("#pi");
//Create norm histograms
  H1D[3] = (TH1D*) H1D[0]->Clone("N1");  H1D[3]->SetTitle("h^{#pm}");
  H1D[4] = (TH1D*) H1D[0]->Clone("N1");  H1D[4]->SetTitle("#pi^{#pm}");
  H1D[5] = (TH1D*) H1D[0]->Clone("N2");  H1D[5]->SetTitle("#pi");
// Fill histograms
// Fill histograms
  ...
  for(Int_t i=0; i<Chain->GetEntries(); i++) {
    ...
    s2=sin(2.*fang);
    pid = Particle.pid;
    if  ((pid == 211) || (pid == -211) || (pid == -321) || (pid == 321) || (pid == -2212) || (pid == 2212) || (pid==-10321)||(pid==10321)||(pid==-3324)||(pid==3324)||(pid==-323)||(pid==323)||(pid==-3114)||(pid==3114)||(pid==-3224)||(pid==3224)||(pid==-10323)||(pid==10323)||(pid==-3112)||(pid==3112)||(pid==-67719)||(pid==67719)||(pid==-3334)||(pid==3334)||(pid==13214)||(pid==13114)||(pid==-46653)||(pid==46653)||(pid==-3312)||(pid==3312)||(pid==-3222)||(pid==3222)||(pid==-9000211)||(pid==9000211)){
      ss2+=s2;
      vv2+=v2;
      count++;
    }
  ...
  for(Int_t i=0; i<Chain->GetEntries(); i++) {
    ...
    pid = Particle.pid;
    if  ((pid == 211) || (pid == -211) || (pid == -321) || (pid == 321) || (pid == -2212) || (pid == 2212) || (pid==-10321)||(pid==10321)||(pid==-3324)||(pid==3324)||(pid==-323)||(pid==323)||(pid==-3114)||(pid==3114)||(pid==-3224)||(pid==3224)||(pid==-10323)||(pid==10323)||(pid==-3112)||(pid==3112)||(pid==-67719)||(pid==67719)||(pid==-3334)||(pid==3334)||(pid==13214)||(pid==13114)||(pid==-46653)||(pid==46653)||(pid==-3312)||(pid==3312)||(pid==-3222)||(pid==3222)||(pid==-9000211)||(pid==9000211)){
//(Particle.pid == 211)||(Particle.pid == -211)||(Particle.pid == 321)||(Particle.pid == -321)|| (Particle.pid == 2212)||(Particle.pid == -2212)||(Particle.pid == 2112)||(Particle.pid == -2212)
    ...
    if  ((pid == 211)||(pid == 321)||(pid == 2212)||(pid==10321)||(pid==3324)||(pid==323)||(pid==3114)||(pid==3224)||(pid==10323)||(pid==3112)||(pid==67719)||(pid==3334)||(pid==13214)||(pid==13114)||(pid==46653)||(pid==3312)||(pid==3222)||(pid==9000211)){
      H1D[1]->Fill(Pt, 1.0 * v2);
      H1D[4]->Fill(Pt, 1.0);
    }

    if  ((pid == -211)||(pid == -321)||(pid == -2212)||(pid==-10321)||(pid==-3324)||(pid==-323)||(pid==-3114)||(pid==-3224)||(pid==-10323)||(pid==-3112)||(pid==-67719)||(pid==-3334)||(pid==-46653)||(pid==-3312)||(pid==-3222)||(pid==-9000211)){
      H1D[2]->Fill(Pt, 1.0 * v2);
      H1D[5]->Fill(Pt, 1.0);
    }
