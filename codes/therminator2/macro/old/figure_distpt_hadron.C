...
#define  _FIGURE_NAME_ "fig_distpthadron"
#define  _N_HISTOGRAMS_ 2

void figure_distpt_hadron(TString aEventDir = "./events/", Int_t aEventFiles = 1)
{
// ##########################################################################
// # READ ROOT FILES
// ##########################################################################
...
// Create histograms
  H1D[0] = new TH1D("H0", "#h^{+}", XBins, XMin, XMax);
...
// Fill histograms
  ...
  for(Int_t i=0; i<Chain->GetEntries(); i++) {
    ...
    if((pid==10321)||(pid==3324)||(pid==323)||(pid==3114)||(pid==3224)||(pid==10323)||(pid==3112)||(pid==67719)||(pid==3334)||(pid==13214)||(pid==13114)||(pid==46653)||(pid==3312)||(pid==3222)||(pid==9000211))
      H1D[0]->Fill(Pt, 1.0/Pt);
    if((pid==-10321)||(pid==-3324)||(pid==-323)||(pid==-3114)||(pid==-3224)||(pid==-10323)||(pid==-3112)||(pid==-67719)||(pid==-3334)||(pid==-46653)||(pid==-3312)||(pid==-3222)||(pid==-9000211))
