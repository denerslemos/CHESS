...
#define  _FIGURE_NAME_ "fig_v2pt"
#define  _N_HISTOGRAMS_ 3

void figure_v2pt(TString aEventDir = "./events/", Int_t aEventFiles = 1)
{
// ##########################################################################
// # READ ROOT FILES
// ##########################################################################
...
// Create histograms
  ...
  H1D[2] = (TH1D*) H1D[0]->Clone("H2");  H1D[2]->SetTitle("h^{-}");
//Create norm histograms
  H1D[3] = (TH1D*) H1D[0]->Clone("N1");  H1D[3]->SetTitle("#pi^{-}");
  H1D[4] = (TH1D*) H1D[0]->Clone("N1");  H1D[4]->SetTitle("h^{+}");
  H1D[5] = (TH1D*) H1D[0]->Clone("N2");  H1D[5]->SetTitle("h^{-}");
// Fill histograms
  Float_t Rap, Pt, v2;
  Int_t   pid;
  for(Int_t i=0; i<Chain->GetEntries(); i++) {
    ...
    pid = Particle.pid;
    if((Particle.pid == 211)||(Particle.pid == 211)||(Particle.pid == 321)||(Particle.pid == 321)|| (Particle.pid == 2212)||(Particle.pid == -2212)||(pid==-10321)||(pid==10321)||(pid==-3324)||(pid==3324)||(pid==-323)||(pid==323)||(pid==-3114)||(pid==3114)||(pid==-3224)||(pid==3224)||(pid==-10323)||(pid==10323)||(pid==-3112)||(pid==3112)||(pid==-67719)||(pid==67719)||(pid==-3334)||(pid==3334)||(pid==13214)||(pid==13114)||(pid==-46653)||(pid==46653)||(pid==-3312)||(pid==3312)||(pid==-3222)||(pid==3222)||(pid==-9000211)||(pid==9000211)) {
      H1D[0]->Fill(Pt, 1.0/Pt * v2);
      H1D[3]->Fill(Pt, 1.0/Pt);
    }
    if((pid == 211)) {
      H1D[1]->Fill(Pt, 1.0/Pt * v2);
...
// Histogram legend
  TLegend* LegendPart	= new TLegend(0.81, 0.18, 0.98, 0.37, "",	"brNDC");
...
// Model legend
  TLegend* LegendModel	= new TLegend(0.17, 0.40, 0.45, 0.92, "model",	"brNDC");
