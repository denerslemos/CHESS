...
#ifndef _TH2_HYPERSURFACEV_H_
  #define _TH2_HYPERSURFACEV_H_

#include <TRandom2.h>
#include "Thermodynamics.h"
#include "Vector3D.h"

class Hypersurface_Lhyquid3V
{
  public:
    Hypersurface_Lhyquid3V();
    ~Hypersurface_Lhyquid3V();

    double GetHyperCubeSpatialVolume();
    double GetDSigmaP(double aMt, double aPt, double aPhiP, double aRapP);
    double GetDSigmaU(double aMt, double aPt, double aPhiP, double aRapP);
