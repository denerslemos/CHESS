...
#ifndef _TH2_MODEL_LHYQUID2VBI_H_
  #define _TH2_MODEL_LHYQUID2VBI_H_

#include "Model.h"
#include "Hypersurface_Lhyquid2V.h"

class Model_Lhyquid2VBI
: public Model,
  public Hypersurface_Lhyquid2V
{
  public:
    Model_Lhyquid2VBI();
    Model_Lhyquid2VBI(TRandom2* aRandom);
    ~Model_Lhyquid2VBI();
    
    double GetIntegrand(ParticleType* aPartType);
    double GetIntegrand(ParticleType* aPartType,int iwb);
...
/*! @file Model_Lhyquid2VBI.h
 * @brief Definition of Model_Lhyquid2VBI class. Hydro based 2+1 freeze-out Model with boost-invariance.
 */
/*! @class Model_Lhyquid2VBI
 * @brief Lhyquid2VBI is a boost-invariant freeze-out model that uses a hypersurface from 
 * hydrodynamic calculation as input.
 *
 * <table>
 *   <tr><th>sModel</th>	<th>Model::mModelName</th>	<th>Description</th></tr>
 *   <tr><td>11</td>		<td>"Lhyquid2VBI"</td>		<td>Hydro based freeze-out model with boost-invariance</td></tr>
 * </table>
 *
 * @fn Model_Lhyquid2VBI::Model_Lhyquid2VBI()
 * @brief Default constructor.
 *
 * @fn Model_Lhyquid2VBI::Model_Lhyquid2VBI(TRandom2* aRandom)
 ...
 * @brief Destructor.
 *
 * @fn double Model_Lhyquid2VBI::GetIntegrand(ParticleType* aPartType)
 ...
 *
 * @fn void Model_Lhyquid2VBI::AddParameterBranch(TTree* aTree)
