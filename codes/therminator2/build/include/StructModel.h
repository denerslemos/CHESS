...
#define _MODEL_T_FORMAT_LHYQUID2VBI_	"RapPRange/F:RapSRange:TauI:TempF:MuB:MuI:MuS:MuC:CollidingEnergy:CentralityMin:CentralityMax:ImpactParameter:TempI:DeviceName[30]/C:CollidingSystem[30]"
