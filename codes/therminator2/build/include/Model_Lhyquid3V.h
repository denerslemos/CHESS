...
#ifndef _TH2_MODEL_LHYQUID3V_H_
  #define _TH2_MODEL_LHYQUID3V_H_

#include "Model.h"
#include "Hypersurface_Lhyquid3V.h"


class Model_Lhyquid3V
: public Model,
  public Hypersurface_Lhyquid3V
{
  public:
    Model_Lhyquid3V();
    Model_Lhyquid3V(TRandom2* aRandom);
    ~Model_Lhyquid3V();
    
    double GetIntegrand(ParticleType* aPartType);
   // WB
    double GetIntegrand(ParticleType* aPartType,int iwb);
    double GetIntegrandU(ParticleType* aPartType);
    double GetIntegrandU(ParticleType* aPartType,int iwb);
