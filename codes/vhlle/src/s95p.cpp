...
void loadSongIC(char* filename, double factor, EoS *eos) {
...
//      cout << "e[ix][iy] =" << e[ix][iy] << endl;
      if (glauberVariable == 1){
      if(e[ix][iy] < 1.0e-8) {ed = 0.0;}
      else {eos->gete(e[ix][iy], ed, nb);}
     // cout << "ed =" << ed << endl;
    }
//        e[ix][iy] = s95p_e(factor * e[ix][iy]);
        //  e[ix][iy] = gete(e[ix][iy], double& e, 0.0)
      else
